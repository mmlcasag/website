create or replace procedure website.proc_pedido_site( -- ENDERECO DE ENTREGA
...
begin
  ...
  send_mail('site-erros@colombo.com.br','site-erros@colombo.com.br','PROC_PEDIDO_SITE','Erro: ' || chr(13) || chr(13) || sqlerrm || ' - Backtrace: ' || DBMS_UTILITY.FORMAT_ERROR_BACKTRACE || chr(13) || 'Debug: ' || chr(13) || chr(13) || chr(13) || v_mensagem);
end;
    
    pmens := 'Erro na PROC_PEDIDO_SITE ' || pmens || ' ' || sqlerrm || ' - Backtrace: ' || DBMS_UTILITY.FORMAT_ERROR_BACKTRACE;
    raise_application_error(-20903, pmens);
end proc_pedido_site;
/
